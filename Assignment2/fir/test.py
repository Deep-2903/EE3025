...
# Bandpass filter specifications (in kHz)
...
plt.grid()
#plt.savefig('./figs/LowPass_digital.pdf')
#plt.savefig('./figs/LowPass_digital.eps')
#subprocess.run(shlex.split("termux-open ./figs/LowPass_digital.pdf"))
...
plt.grid()
#plt.savefig('./figs/BandPass_digital.pdf')
#plt.savefig('./figs/BandPass_digital.eps')
#subprocess.run(shlex.split("termux-open ./figs/BandPass_digital.pdf"))
plt.show()
